...
public class ContainsInAnyOrderTest {
    ...
    reports_when_the_actual_collection_is_empty() {
        ...
        Matcher<Iterable<? extends String>> containsOne = Contains.inAnyOrder("a");
    ...
    reports_when_expected_collection_was_empty_but_items_were_unexpectedly_returned() {
        ...
        Matcher<Iterable<? extends String>> containsEmpty = Contains.inAnyOrder();
    ...
    reports_the_unmatched_expectations_when_actual_list_shorter_than_expected_list() {
        ...
        Matcher<Iterable<? extends String>> containsOneAndTwo = Contains.inAnyOrder("a", "b");
        List<String> listOfOne = Collections.singletonList("a");
    ...
    reports_all_unmatched_expectations() {
        ...
        Matcher<Iterable<? extends String>> contains1234 = Contains.inAnyOrder("a", "b", "c", "d");
        List<String> listOfOne = Collections.singletonList("a");
    ...
    accepts_when_right_items_are_found_but_in_the_wrong_order() {
        ...
        Matcher<Iterable<? extends String>> containsOneTwo = Contains.inAnyOrder("a", "b");
    ...
    reports_each_unmatched_item() {
        ...
        Matcher<Iterable<? extends String>> containsOneTwo = Contains.inAnyOrder("a", "b", "c");
    ...
    reports_indices_of_unmatched_matchers_and_unexpected_items() {
        ...
        Matcher<Iterable<? extends String>> expected = Contains.inAnyOrder("a", "b", "c", "e", "f");
    ...
    test_reports_unexpected_and_missing_items() {
        ...
        Matcher<Iterable<? extends String>> containsABCD = Contains.inAnyOrder("a", "b", "c", "d");
    ...
    matches_on_null_elements_in_lists() {
        Matcher<Iterable<? extends String>> containsNull = Contains.inAnyOrder("a", null);
    ...
    reports_when_null_element_was_expected_but_not_seen() {
        Matcher<Iterable<? extends String>> containsaNull = Contains.inAnyOrder("a", null);
    ...
    describes_possible_mismatch_when_only_one_unsatisfied_match_and_one_unexpected_item() {
        Matcher<Iterable<? extends String>> matcher = Contains.inAnyOrder("a", "b");
    ...
    can_use_matchers_for_elements_in_list() {
        Matcher<Iterable<? extends String>> containsAB = Contains.inAnyOrder(Matchers.containsString("a"), Matchers.containsString("b"));
        List<String> listOfAAABBB = Arrays.asList("aaaaaa", "bbbbbbbbbb");
        assertThat(containsAB, is(a_matcher_that_matches(listOfAAABBB)));
    }
    
    private void listOutput(Matcher<Iterable<? extends String>> containsOne, List<String> emptyList) {
