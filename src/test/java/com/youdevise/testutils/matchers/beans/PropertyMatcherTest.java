...
public class PropertyMatcherTest {
    ...
    describes_mismatch_when_asked_to_match_on_a_private_property() {
        ...
        assertThat(matcher, is(a_matcher_giving_a_mismatch_description_of(value,
                                   either(/* Java 8*/ equalTo("whose \"password\" field could not be read, due to:<java.lang.IllegalAccessException: " +
                                           ...
                                           .or(/* Java 10 */ equalTo("whose \"password\" field could not be read, due to:<java.lang.IllegalAccessException: " +
